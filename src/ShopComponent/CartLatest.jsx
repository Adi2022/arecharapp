...
const CartLatest = () => {
	...
	const fetchBlogs = async () => {
		try {
			const response = await axios.get("https://myapp-8q5z.onrender.com/cartProduct");
					...
					<Paper style={{ marginTop: "16px", padding: "8px" }}>
						<Grid container spacing={2} alignItems="center">
							...
							>
								...
								<Typography fontSize="15px" fontWeight="400" align="left" color="#6C757E"></Typography>
							</Grid>
							...
							<Grid item xs={3} md={2.4}>
								<Typography variant="body1" align="center" color="#ff0000"></Typography>
							</Grid>
							<Grid item xs={3} md={2.4}>
								<Typography fontSize="1.25rem" fontWeight="700" align="center" color="#555"></Typography>
							</Grid>
							<Grid item xs={3} md={2.4}>
								<IconButton
									aria-label="delete"
