...
import GrapeSeeds from "../assets/Grape_Seed_Extract.png";
const styles = {
	main: {
		paddingLeft: "6%",
		paddingRight: "6%",
	...
	return (
		<Grid container style={styles.main}>
			<Box sx={{ textAlign: "center", width: "100%" }}>
				...
				<Fade in={checked === true} timeout={1000}>
					<Typography sx={styles.bannerTitleStyle3}>Grape</Typography>
				</Fade>

				<Fade in={checked === true} timeout={1000}>
					<Typography sx={styles.bannerTitleStyle2}>
						The grape flavoured Hair & Nails gummies is just delectable.
					</Typography>
				</Fade>
			</Box>
		</Grid>
...
export default ProductVitagoliTaste;
