...
const VitagolProductInfo = () => {
	return (
		<div style={{ backgroundColor: "#009090", minHeight: "40vh", alignItems: "center",width:"100%"}}>
			<Typography variant="h2" fontWeight={"bold"} color="white" align="center" marginTop={"40px"}>
				Why Vitagol?
			</Typography>
			<Typography margin="2rem" padding="4rem" color="white" align="center" fontWeight={"bold"}>
